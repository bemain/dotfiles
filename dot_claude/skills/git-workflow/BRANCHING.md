# Git Branching Strategies — Reference

The three common branching models, with rules and a comparison table. Pulled out of `git-workflow/SKILL.md` so the SKILL stays focused on day-to-day operations.
