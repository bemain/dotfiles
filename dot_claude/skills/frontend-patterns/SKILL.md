...
For memoization (`useMemo`, `useCallback`, `React.memo`), code splitting with `lazy`/`Suspense`, and list virtualization via `@tanstack/react-virtual`, see [PERFORMANCE.md](PERFORMANCE.md).
...
For Framer Motion list animations and modal enter/exit patterns, see [ANIMATION.md](ANIMATION.md).
